<template>
  <a-modal :open="visible" title="添加/编辑" :width="700" forceRender ok-text="确认" cancel-text="取消" @ok="onSubmit" @cancel="onClose">
    <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 6 }">
      <a-form-item label="购入日期（合同编号）" name="purchaseDateContractNumber">
        <a-input v-model:value="form.purchaseDateContractNumber" placeholder="请输入购入日期及合同编号" />
      </a-form-item>
      <a-form-item label="喷头型号" name="sprinklerModel">
        <a-input v-model:value="form.sprinklerModel" placeholder="请输入喷头型号" />
      </a-form-item>
      <a-form-item label="喷头序列号" name="sprinklerSerial">
        <a-input v-model:value="form.sprinklerSerial" placeholder="请输入喷头序列号" />
      </a-form-item>
      <a-form-item label="发货日期" class="smart-query-form-item">
        <a-space direction="vertical" :size="12">
          <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.shippingDate" style="width: 150px" />
        </a-space>
      </a-form-item>
      ...
      <a-form-item label="电压" name="voltage">
        <a-input v-model:value="form.voltage" placeholder="请输入电压" />
      </a-form-item>
      <a-form-item label="jetsout" name="jetsout">
        <a-input v-model:value="form.jetsout" placeholder="请输入jetsout" />
      </a-form-item>
      <a-form-item label="历史" name="history">
        <a-input v-model:value="form.history" placeholder="请输入历史" />
      </a-form-item>
...
<script setup>
  ...
  const formDefault = {
    purchaseDateContractNumber: undefined,
    sprinklerModel: undefined,
