...
INSERT INTO `t_system_config` (`id`, `config_name`, `config_key`, `config_value`, `config_group`, `is_using`, `remark`, `update_time`, `create_time`) VALUES
	...
	(15, '邮件发配置', 'email_config', '{"password":"smartadmin","smtpHost":"smtp.163.com","username":"{"password":"smartadmin","smtpHost":"smtp.163.com","username":"smartadmin1024@163.com"}"}', 'email', 1, NULL, '2019-09-04 16:42:17', '2019-05-13 16:57:48'),
