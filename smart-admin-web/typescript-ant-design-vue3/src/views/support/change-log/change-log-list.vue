  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="smart-table-btn-block">
      <div class="smart-table-operate-block">
        <a-button @click="showForm" type="primary" v-privilege="'changeLog:add'">
          <template #icon>
            <PlusOutlined />
          </template>
          新建
        </a-button>
        <a-button @click="confirmBatchDelete" type="danger" :disabled="selectedRowKeyList.length == 0" v-privilege="'changeLog:batchDelete'">
          <template #icon>
            <DeleteOutlined />
          </template>
          批量删除
